...
"""
    ...
    # Generate/retrieve member profiles
    members = []
...
def create_ui():
    ...
    """) as app:
        ...
        generate_group_btn.click(
            ...
            inputs=[group_size, model_group, search_existing] + all_member_inputs,
